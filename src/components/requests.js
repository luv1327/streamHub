...
const movieRequest = {
  ...
  fetchTopRated2: `${baseUrl}/movie/top_rated?api_key=${apiKey}&language=en-US&page=2`,
  fetchTopRated3: `${baseUrl}/movie/top_rated?api_key=${apiKey}&language=en-US&page=3`,
  fetchUpcoming: `${baseUrl}/movie/upcoming?api_key=${apiKey}&language=en-US&page=1`,
  fetchUpcoming2: `${baseUrl}/movie/upcoming?api_key=${apiKey}&language=en-US&page=2`,
  fetchUpcoming3: `${baseUrl}/movie/upcoming?api_key=${apiKey}&language=en-US&page=3`,
  fetchNowPlaying: `${baseUrl}/movie/now_playing?api_key=${apiKey}&language=en-US&page=1`,
  fetchNowPlaying2: `${baseUrl}/movie/now_playing?api_key=${apiKey}&language=en-US&page=2`,
  fetchNowPlaying3: `${baseUrl}/movie/now_playing?api_key=${apiKey}&language=en-US&page=3`,
  ...
  fetchPopular3: `${baseUrl}/movie/popular?api_key=${apiKey}&language=en-US&page=3`,
